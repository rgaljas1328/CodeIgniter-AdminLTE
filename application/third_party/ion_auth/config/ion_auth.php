...
$config['chairman_group']             = 'chairman';             // Default chairmans group, use name
$config['registrar_group']            = 'registrar';             // Default registrar group, use name
$config['assessor_group']             = 'assessor';             // Default registrar group, use name
