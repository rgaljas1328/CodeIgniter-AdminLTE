...
class Ion_auth
{
	...
	public function is_chairman($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_chairman');

		$chairman_group = $this->config->item('chairman_group', 'ion_auth');

		return $this->in_group($chairman_group, $id);
	}
