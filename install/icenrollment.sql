...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2018 at 06:00 AM
...
(1, 'Laboratory Fee', 100),
(2, 'Maticulation', 170),
(3, 'Library and Athletic', 100),
(4, 'Development Fee', 150),
(5, 'CMT/NSTP', 150);
...
(15, 8, '2', 0, 1, '2018-08-08'),
(16, 8, '1', 0, 1, '2018-08-08');
...
--
-- Dumping data for table `subjectoffering`
--

INSERT INTO `subjectoffering` (`ID`, `academicyear_id`, `instructor_id`, `subj_id`, `room_id`, `subjectoffering_slots`, `subjectoffering_section`, `subjectoffering_timein`, `subjectoffering_timeout`, `subjectoffering_days`, `subjectoffering_status`) VALUES
(1, 41, 1, 11, 10, 50, 'A', '06:45:00', '07:45:00', 'M-TH', 'Active');
...
(1, '127.0.0.1', 'administrator', '$2y$08$xaqVLAcWmATSqPiWHGTWn.oFHYxTeSEI4jzaOaA1pxDnVl8.xib06', '', 'admin@admin.com', '', NULL, NULL, 'SqLf9PmqMU99/wRoTvqMwO', 1268889823, 1536904137, 1, 'Reymond', 'Aljas', 'ADMIN', '09090649289', '', '', '', '', '', 'ADMIN');
